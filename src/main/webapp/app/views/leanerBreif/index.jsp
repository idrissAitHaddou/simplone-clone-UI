          ...
          <form id="addPromotionForm" action="javascript:addPromotion()" method="post" enctype="multipart/form-data">
            ...
            <div class="flex my-6 justify-center">
              <div class="w-full flex item-center">
                <textarea placeholder="Description" id="posentage" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"></textarea>
              </div>
            </div>
            <div class="flex my-6 justify-center">
              <div class="w-full flex item-center">
                <select class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md">
                  <option disabled selected>Select user</option>
                  <option>All</option>
                  <option>Formers</option>

                    ...
                    <div class="profile-header">
                        ...
                        <div class="profile-info">
                            <div class="post info-flex">
                                ...
                                <span id="suitesCount" class="info-bold">42</span>
                            </div>
                            <div class="followers info-flex">
                                <span class="info-color">Rooms</span>
                                <span id="roomsCount" class="info-bold">12</span>
                            </div>
                            <div class="following info-flex">
                                <span class="info-color">Bookings</span>
                                <span id="bookingsCount" class="info-bold">14</span>
                            </div>
                        </div>
                    </div>
                    <div class="profile-body">
                        <span id="fullname" class="body-name">idriss ait haddou</span>
                        <span id="email" class="body-job">idriss@gmail.com</span>
                    </div>

...
<body>
    <div id="loadingValidateLogin" class="bg-[#14BDEE] absolute z-[9999] right-10 top-8 flex items-center px-4 py-2 text-gray-500 rounded-lg shadow" role="alert">
        <button
                type="submit"
                ...
                <form method="post" action="javascript:login()" class="flex flex-col space-y-5">
                    ...
                    <div class="flex flex-col space-y-1">
                        <div class="flex items-center justify-between">
                            ...
                            <a href="/email/reset-password?role=learner" class="text-sm text-[#14BDEE] hover:underline focus:text-[#14BDEE]">Forgot Password?</a>
                        </div>
                        <input
                                type="password"
                                id="password"
                    ...
                    <div>
                        <button
                                type="submit"
                                class="w-full px-4 py-2 text-lg font-semibold text-white transition-colors duration-300 bg-[#14BDEE] rounded-md shadow focus:outline-none focus:ring-blue-200 focus:ring-4"
                        >
                            Log in
                        </button>
                    </div>
               ...
               $("#loadingValidateLogin").show()
                ...
                $.ajax({
                    ...
                    success : function (response){
                        $("#loadingValidateLogin").hide()
                        response.status == "success" ? window.location = "http://localhost:8085/learner/dashboard" : toastError("Password or Email not invalid !!!", "toast-success")
                    },

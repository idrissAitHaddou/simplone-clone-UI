      ...
      <%--     start card breif--%>
        <div class="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md">
          ...
          <div class="p-5">
            ...
            <a href="/learner/breifs-description" class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-[#14BDEE] rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300">
              Read more

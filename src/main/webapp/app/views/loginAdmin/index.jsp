                ...
                <form method="post" action="javascript:login()" class="flex flex-col space-y-5">
                    ...
                    <div class="flex flex-col space-y-1">
                        <div class="flex items-center justify-between">
                            ...
                            <a href="/email/reset-password?role=admin" class="text-sm text-[#14BDEE] hover:underline focus:text-[#14BDEE]">Forgot Password?</a>
                        </div>
                        <input
                                type="password"
                                id="password"
               ...
               $("#loadingValidateLogin").show()
                ...
                $.ajax({
                    ...
                    success : function (response){
                        $("#loadingValidateLogin").hide()
                        response.status == "success" ? window.location = "http://localhost:8085/admin/dashboard" : toastError("Password or Email not invalid !!!", "toast-success")
                    },

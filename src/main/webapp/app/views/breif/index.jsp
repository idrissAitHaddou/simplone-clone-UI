...
<div class="p-6">
    <nav class="flex justify-between mb-8" aria-label="Breadcrumb">
      <input type="text" placeholder="Search by name" class="text-gray-800 block max-w-lg w-64 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md">
